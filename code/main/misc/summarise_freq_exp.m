clear all;
master_dir =  "D:\PhD\results\frequency_domain";
experiment_types = {'mean_intercept', 'partitions', 'onsets'};
factors = {'visual_stress', 'discomfort', 'headache'};
frequency_bands = ["8_13", "20_35", "30_45", "45_60", "60_80"];
